...
[CustomEditor(typeof(DisplayMeshFilterNormals))]
public class DisplayMeshFilterNormalsEditor : Editor {

	public override void OnInspectorGUI(){
		
		DisplayMeshFilterNormals myScript = (DisplayMeshFilterNormals)target;
