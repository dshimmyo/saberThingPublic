...
public class VRTeleporter : MonoBehaviour
{
    ...
    [SerializeField] private float angle = 45f; // Arc take off angle

    [SerializeField] private float strength = 10f; // Increasing this value will increase overall arc length
